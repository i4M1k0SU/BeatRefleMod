...
namespace BeatRefleMod.Mods
{
    internal class JudgeOverlay : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            font = appMain.localizeModel.GetFont(Orgesta.AppMain.currentLanguage, false);
        }
        ...
        public void OnGUI()
        {
            ...
            GUI.Label(new Rect(x, y += style.fontSize, width, style.fontSize), "GREAT\t: " + judgeNotesNum[1].ToString(), style);
            style.normal.textColor = new Color(247f / 255f, 116f / 255f, 63f / 255f);
            GUI.Label(new Rect(x, y += style.fontSize, width, style.fontSize), "GOOD\t: " + judgeNotesNum[2].ToString(), style);
            style.normal.textColor = new Color(41f / 255f, 166f / 255f, 162f / 255f);
            GUI.Label(new Rect(x, y += style.fontSize, width, style.fontSize), "POOR\t: " + judgeNotesNum[3].ToString(), style);
            style.normal.textColor = new Color(74f / 255f, 85f / 255f, 90f / 255f);
            GUI.Label(new Rect(x, y += style.fontSize, width, style.fontSize), "BAD\t: " + judgeNotesNum[4].ToString(), style);
            ...
            GUI.Label(new Rect(x, y += style.fontSize, width, style.fontSize), "RATING\t: " + scoreManager.Rating.ToString(), style);
            style.normal.textColor = Color.white;
            GUI.Label(new Rect(180, 8, width, style.fontSize), "総ノーツ数 : " + scoreManager.NotesCount.ToString(), style);
        }
